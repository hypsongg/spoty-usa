...
// Carregando B1
    function showLoadingB1() {
        var button = document.getElementById("B1");
            showPopupB1();
            playAudio();
            // Yesulando um atraso de 3 segundos para o showPopup2()
            setTimeout(function () {
                closePopupB1();
                aumentarValor();
                trocarDiv('ad1', 'ad2');
...
function showLoading() {
  ...
  // Yesulando um atraso de 3 segundos para a anima̤̣o
  setTimeout(function() {
...
function formatarValor(input) {
  // Remove tos os caracteres ṇo num̩ricos
...
function updateStars(elementId, className, color) {
    ...
    if (starElement) {
        ...
        console.error("Elemento No encontrado com ID: " + elementId);
    }
}
